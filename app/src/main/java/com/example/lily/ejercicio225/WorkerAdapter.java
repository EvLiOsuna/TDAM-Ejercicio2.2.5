...
public class WorkerAdapter extends RecyclerView.Adapter<WorkerAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView;
        if(cWorkers!=null){
            itemView = inflater.inflate(com.example.lily.ejercicio225.R.layout.worker,parent,false);
        }
        else{
            itemView = inflater.inflate(com.example.lily.ejercicio225.R.layout.worker_single_item,parent,false);
        }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(cWorkers!=null){
            ...
            public void onClick(View view) {
                ...
                View view1 = layoutInflater.inflate(com.example.lily.ejercicio225.R.layout.edit_worker,null);

                final EditText input_nombre = (EditText) view1.findViewById(com.example.lily.ejercicio225.R.id.edtNombre);
                final EditText input_actividad = (EditText) view1.findViewById(com.example.lily.ejercicio225.R.id.edtActividad);
                final EditText input_celular = (EditText) view1.findViewById(com.example.lily.ejercicio225.R.id.edtCelular);

                final Button btnSave = (Button) view1.findViewById(com.example.lily.ejercicio225.R.id.btnGuardar);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView, final WorkerAdapter.OnItemClickListener listener) {
            ...
            txtActividad = this.itemView.findViewById(com.example.lily.ejercicio225.R.id.txtActividad);
            txtCelular = this.itemView.findViewById(com.example.lily.ejercicio225.R.id.txtCelular);
            if(cWorkers!=null){
                btnEdit = this.itemView.findViewById(com.example.lily.ejercicio225.R.id.btnEdit);
                btnDelete = this.itemView.findViewById(com.example.lily.ejercicio225.R.id.btnDelete);
            }
