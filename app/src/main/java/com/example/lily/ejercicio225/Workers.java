...
public class Workers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.lily.ejercicio225.R.layout.activity_workers);

        FloatingActionButton fab = (FloatingActionButton) findViewById(com.example.lily.ejercicio225.R.id.fab);
        fetchWorkersRecords();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View mView1 = inflater.inflate(com.example.lily.ejercicio225.R.layout.add_worker,null);

                final EditText input_nombre = (EditText) mView1.findViewById(com.example.lily.ejercicio225.R.id.edtNombre);
                final EditText input_actividad = (EditText) mView1.findViewById(com.example.lily.ejercicio225.R.id.edtActividad);
                final EditText input_celular = (EditText) mView1.findViewById(com.example.lily.ejercicio225.R.id.edtCelular);

                final Button btnSave = (Button) mView1.findViewById(com.example.lily.ejercicio225.R.id.btnGuardar);
    ...
    public void fetchWorkersRecords() {
        try{
            rcvWorkers= (RecyclerView) findViewById(com.example.lily.ejercicio225.R.id.rcvWorkers);
