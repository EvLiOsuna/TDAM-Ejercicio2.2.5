...
public class Buildings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.lily.ejercicio225.R.layout.activity_buildings);
    try {
        rcvBuildings = (RecyclerView) findViewById(com.example.lily.ejercicio225.R.id.rcvBuildings);
        ...
        fap = findViewById(com.example.lily.ejercicio225.R.id.fab);
    }catch (Exception e){
