...
public class BuildingAdapter extends RecyclerView.Adapter<BuildingAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(com.example.lily.ejercicio225.R.layout.build,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View mView1 = inflater.inflate(com.example.lily.ejercicio225.R.layout.add_building,null);
                ...
                edtNombre = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtNombre);
                edtDireccion = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtDireccion);
                edtCelular = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtCelular);
                edtMail = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtMail);
                edtDescipcionObra = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtDescripcionObra);
                edtMonto = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtMonto);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView, final OnItemClickListener listener) {
            super(itemView);
            txtNombre = this.itemView.findViewById(com.example.lily.ejercicio225.R.id.txtNombre);
            txtDireccion = itemView.findViewById(com.example.lily.ejercicio225.R.id.txtDireccion);
            txtCelular = itemView.findViewById(com.example.lily.ejercicio225.R.id.txtCelular);
            txtMail = itemView.findViewById(com.example.lily.ejercicio225.R.id.txtMail);
            txtDescipcionObra = itemView.findViewById(com.example.lily.ejercicio225.R.id.txtDescripcionObra);
            txtMonto = itemView.findViewById(com.example.lily.ejercicio225.R.id.txtMonto);
            txtEstado = itemView.findViewById(com.example.lily.ejercicio225.R.id.txtEstado);
            btnDelete = itemView.findViewById(com.example.lily.ejercicio225.R.id.btnDelete);
            btnEdit = itemView.findViewById(com.example.lily.ejercicio225.R.id.btnEdit);
