...
public class Detalle_Obra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.lily.ejercicio225.R.layout.activity_detalle__obra);

        rcvWorkers= (RecyclerView) findViewById(com.example.lily.ejercicio225.R.id.rcvTodosTrabajadores);
        ...
        rcvDetalleTrabajadores= (RecyclerView) findViewById(com.example.lily.ejercicio225.R.id.rcvDetalleTrabajadores);
        ...
        adapterDetalle.setOnItemClickListener(new WorkerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final int position) {
                ...
                View mView1 = inflater.inflate(com.example.lily.ejercicio225.R.layout.detalle_edit,null);
                ...
                _txtNombre = mView1.findViewById(com.example.lily.ejercicio225.R.id.txtNombre);
                _txtActividad = mView1.findViewById(com.example.lily.ejercicio225.R.id.txtActividad);

                edtFechaInicio = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtFechaInicio);
                edtFechaFin = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtFechaFin);
                edtCantidad = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtCantidad);
                edtPago = mView1.findViewById(com.example.lily.ejercicio225.R.id.edtPago);
                ...
                btnGuardar = mView1.findViewById(com.example.lily.ejercicio225.R.id.btnGuardar);
                btnEliminar = mView1.findViewById(com.example.lily.ejercicio225.R.id.btnEliminar);
        ...
        adapter.setOnItemClickListener(new WorkerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final int position) {
                //SE INFLA EL EDIT
                LayoutInflater inflater = getLayoutInflater();
                View mView1 = inflater.inflate(com.example.lily.ejercicio225.R.layout.detalle,null);
    ...
    private void initAllComponents() {
        txtNombre = findViewById(com.example.lily.ejercicio225.R.id.txtNombre);
        txtDireccion = findViewById(com.example.lily.ejercicio225.R.id.txtDireccion);
        txtCelular = findViewById(com.example.lily.ejercicio225.R.id.txtCelular);
        txtMail = findViewById(com.example.lily.ejercicio225.R.id.txtMail);
        txtDescripcion = findViewById(com.example.lily.ejercicio225.R.id.txtDescipcion);
        txtMonto = findViewById(com.example.lily.ejercicio225.R.id.txtMonto);
        txtEstado = findViewById(com.example.lily.ejercicio225.R.id.txtEstado);
